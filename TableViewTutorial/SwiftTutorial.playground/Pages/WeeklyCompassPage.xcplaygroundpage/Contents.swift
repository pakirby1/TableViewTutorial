...
compass.addList(
    {
        var list = List(description: "Long Term Goals", numItems: 4, type: .Unordered)
...
compass.addList(
    {
        var list = List(description: "Individual", numItems: 6, type: .Unordered)
...
compass.addList(
    {
        var list = List(description: "Career", numItems:4, type: .Unordered)
